#!/usr/bin/env python3
"""Regenerate the startup splash-screen assets.

The firmware consumes a 1-bit bitmap header generated from the canonical
artwork source: `tools/splash_screen_source.png`.
"""
...
W, H = 540, 960
# Full-height splash — source artwork already includes any footer / status
# region, so no crop is applied. The firmware overlays dynamic text on top.
ART_HEIGHT = H
SCRIPT_DIR = Path(__file__).resolve().parent
REPO_ROOT = SCRIPT_DIR.parent
SOURCE_IMAGE = Path(os.environ.get("SPLASH_SCREEN_SOURCE", SCRIPT_DIR / "splash_screen_source.png"))
BMP_PATH = SCRIPT_DIR / "splash_screen.bmp"
...
def main() -> None:
    ...
    with open(HEADER_PATH, "w", encoding="utf-8") as f:
        f.write("// Auto-generated from tools/generate_splash_screen.py — do not edit\n")
        ...
        f.write("static const uint8_t SPLASH_BITMAP[] PROGMEM = {\n")
